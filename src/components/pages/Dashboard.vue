...
<template>
  <div class="grid gap-4 md:grid-cols-2 md:gap-8 xl:grid-cols-4">
    <Card>
      <CardHeader
  ...
  <div class="grid gap-4 md:gap-8 2xl:grid-cols-3">
    <Card class="2xl:col-span-2">
      <CardHeader class="flex flex-row items-center">
        ...
        <Button as-child class="ml-auto gap-1" size="sm">
          <a href="#">
            View All
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell class="hidden md:hidden lg:hidden xl:table-column">
                2023-06-23
              </TableCell>
